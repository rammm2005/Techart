...
const AboutMe = () => {
    return (
        <>
            <section className="flex flex-row gap-48 mt-24 items-center justify-center">
                ...
                <div className="flex flex-col items-start gap-2">
                    ...
                    <div className="flex flex-col gap-2 w-full mt-6 text-start">
                        <span className="font-semibold">User Experience Design - UI/UX</span>
                        <div className="rounded-full w-full bg-slate-200 h-4">
                            <div className="rounded-full bg-blue-600 h-full w-11/12"></div>
                        </div>
                    </div>

                    <div className="flex flex-col gap-2 w-full mt-6 text-start">
                        <span className="font-semibold">Web & User Interface Design - Development</span>
                        <div className="rounded-full w-full bg-slate-200 h-4">
                            <div className="rounded-full bg-blue-600 h-full w-3/5"></div>
                        </div>
                    </div>

                    <div className="flex flex-col gap-2 w-full mt-6 text-start">
                        <span className="font-semibold">Interaction Design - Animation</span>
                        <div className="rounded-full w-full bg-slate-200 h-4">
                            <div className="rounded-full bg-blue-600 h-full w-5/6"></div>
                        </div>
                    </div>
